...
default_origins = "https://vellorscents.vercel.app,https://vellorscents.vercel.app/,http://localhost:5173,http://localhost:3000"
...
@app.put("/api/resellers/{reseller_id}", response_model=schemas.Reseller)
